...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--how_many', type=int, default=1500, help='how many test images to run')
        parser.add_argument('--train_flip', type=bool, default=False, help='whether to flip the image or not')
        self.isTrain = False
        return parser

    def parse(self):
        parser = self.initialize(argparse.ArgumentParser(description='test options'))
